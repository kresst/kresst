export const ERROR_MESSAGES = {
    ...
    METHOD_MUST_BE_A_STRING: (key: string | symbol, method: any) => `Method for route ${key} should be a string, got: ${method}`,
    UNRECOGNIZED_SERVER_METHOD: (key: string | symbol, method: string) => `Unrecognized method used for route ${key}: ${method}`,
